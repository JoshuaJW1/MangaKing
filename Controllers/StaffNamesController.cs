...
namespace MangaKing.Controllers
{
    public class StaffNamesController : Controller
    {
        private readonly MemberDbContext _context;

        public StaffNamesController(MemberDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Department,Email,Password")] StaffNames staffNames)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Department,Email,Password")] StaffNames staffNames)
        {
            if (id != staffNames.Id)
            {
                return NotFound();
